...
CC :=$(GCCPREFIX)gcc
LAB_FLA	:= $(LAB1) $(LAB2) $(LAB3) $(LAB4) $(LAB10)
...
MODULES   := init driver libs trap mm debug sync process schedule syscall fs fs/vfs fs/sfs fs/devs iotest
